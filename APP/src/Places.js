    ...
    <div className="sm:ml-24">
        <div className=" max-w-2xl mx-auto">
            <div className="flex items-center">
                <div className="relative w-full mt-28 sm:mt-10 mx-5 sm:mx-0 z-10">
                ...
                <div onClick={consulta} className="mx-5 sm:mx-0 mt-28 cursor-pointer sm:mt-10 inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-zinc-700 rounded-lg border border-zinc-700 hover:bg-zinc-800 focus:ring-4 focus:outline-none focus:ring-zinc-300">
