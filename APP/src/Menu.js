    ...
    return (
        <div>
            ...
            <div className="w-full sm:w-auto sm:h-screen flex fixed z-50">
                <div className="w-full pl-5 sm:pl-0 flex sm:flex-col justify-between items-center bg-zinc-900 text-gray-700 shadow sm:h-full">

                    <a href="/">
                        <img className="m-2 sm:m-0 sm:mt-4 w-14 mx-auto" src="/black.png" alt="logo" />
                    </a>
                    <div className='pr-5 sm:pr-0 sm:hidden flex items-center text-zinc-100 cursor-pointer' onClick={() => setSowPhoneMenu(!sowPhoneMenu)}>
            ...
            {
                sowPhoneMenu &&
                <ul className='bg-zinc-900 fixed w-full mt-16 z-50'>
                    <li className="hover:bg-zinc-800">
